...
implementation without becoming a second contract.

| Document | Use it for |
|---|---|
| [Completed legacy baseline](../plans/legacy.md) | Consolidated architecture, ownership, operation, change control, and proof ledger |
...
The completed developer, operator, and standalone architecture documents were
consolidated into `plans/legacy.md`. PDF and HTML files in this folder are
supporting workshop or methodology artifacts. They do not replace executable
