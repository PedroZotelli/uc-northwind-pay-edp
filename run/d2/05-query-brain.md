...
J2 cites Marina: **173.44** vs **173.45**. J1 names PAN / CPF. J5 does **not** invent Java. Notebook still **nine** sources. No git writes.

## If fail

No Google / empty notebook → pair. `spec/` is on disk. Do not dump Java into NotebookLM.
