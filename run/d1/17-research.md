...
1. Ask the **Second Brain**: "What does *paid* mean for Type 01, and which
   meeting contradicts the layout?" The answer must cite a page.
2. Ask **OntoLayer**: "Which procedure writes
   `reporting.card_settlement_reconciliation`, and what is its grain?"
3. Name the **seams** from the repo: raw → sanitize → stage → apply → report,
   and who owns each arrow.

## Proof

The room can restate, from the tools — not from memory: what *paid* means, the
grain of the reconciliation, and the five seams. Citations, not guesses.
