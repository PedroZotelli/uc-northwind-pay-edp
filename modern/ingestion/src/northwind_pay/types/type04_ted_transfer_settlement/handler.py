"""Compose admission, parsing, schema, and publication for one Type 04 batch."""
...
def process(bundle: Path, *, landing_root: Path) -> BatchOutcome:
    ...
    result = publish(
        ...
        manifest={
            ...
            "computed_detail_count": controls.computed_transfer_count,
            "computed_net_amount": f"{controls.computed_net_amount:.2f}",
            "contract_code": source.contract_code,
            "contract_version": source.contract_version,
            "currency": "BRL",
            "declared_detail_count": controls.declared_transfer_count,
