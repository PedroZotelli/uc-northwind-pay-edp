...
from . import contracts as contract_loader
from .attribution.source_system import attribute
from .canonical import serialize
from .config import REPOSITORY_ROOT, DetectorConfiguration, detector_source_digest
...
DEFAULT_EVIDENCE_ROOT = REPOSITORY_ROOT / "evidence" / "dark-factory"
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        help="Dark Factory evidence root (default: evidence/dark-factory).",
    )
    parser.add_argument(
        "--withhold",
        action="append",
