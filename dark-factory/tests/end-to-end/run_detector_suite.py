...
sys.path.insert(0, str(REPOSITORY_ROOT / "dark-factory" / "src"))

from darkfactory import cli  # noqa: E402
from darkfactory import contracts as contract_loader  # noqa: E402
from darkfactory.canonical import (  # noqa: E402
    encode,
    fixture_projection,
    identity_bytes,
)
from darkfactory.config import DetectorConfiguration  # noqa: E402
from darkfactory.errors import (  # noqa: E402
    AttributionInconclusiveError,
    DarkFactoryError,
)
from darkfactory.findings import privacy  # noqa: E402
from darkfactory.findings import writer as finding_writer  # noqa: E402
from darkfactory.observations import postgres as postgres_adapter  # noqa: E402
from darkfactory.observations import transport as transport_adapter  # noqa: E402
from darkfactory.observations.collect import WITHHOLDABLE_CHANNELS  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--evidence-root",
        type=Path,
        default=REPOSITORY_ROOT / "evidence" / "dark-factory",
    )
