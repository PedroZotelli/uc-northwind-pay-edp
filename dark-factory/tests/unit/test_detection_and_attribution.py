...
from darkfactory.observations.collect import WITHHOLDABLE_CHANNELS
from darkfactory.observations.model import (
    CHANNEL_JAVA,
...
class AttributionTest(unittest.TestCase):
    ...
    def test_a_disagreeing_declaration_also_fails_the_attribution_rule(self) -> None:
        ...
        from darkfactory.attribution.source_system import _declaration_consistent
