...
Staff: Day 1 upload [`../../run/d1/12-notebooklm.md`](../../run/d1/12-notebooklm.md) · Day 2 query [`../../run/d2/05-query-brain.md`](../../run/d2/05-query-brain.md) · Day 3 query [`../../run/d3/02-query-brain.md`](../../run/d3/02-query-brain.md) · Day 3 research [`../../run/d3/12-research.md`](../../run/d3/12-research.md)
